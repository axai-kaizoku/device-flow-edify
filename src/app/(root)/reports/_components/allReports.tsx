...
import { getAssignedDevicesReport, getDeviceReport, getSoldInventoryReport, getUserReports } from '@/server/reportsAction';
  ...
  return (
    ...
    >
        ...
        {report.title === 'Devices Report' ? (
            ...
            <div className="text-gray-500 italic">No action available right now</div>
        )}
    </div>
  )
}
