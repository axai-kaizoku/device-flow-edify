...
// 	// Trigger search and filter on searchTerm or filters change
// 	useEffect(() => {
...
// 		let finalFilterValue: any = filterValue.trim();
...
// 		// Add new filter
// 		const newFilter = [filterField, filterType, finalFilterValue];
// 		setFilters([...filters, newFilter]); // Allow multiple filters
...
// 				{/* Pagination controls */}
// 				<button
// 					disabled={pageLength === 20}
// 					onClick={() => setPageLength(20)}
// 					className="bg-gray-300 p-2 rounded">
// 					Load 20
// 				</button>
// 				<button
// 					disabled={pageLength === 100}
// 					onClick={() => setPageLength(100)}
// 					className="bg-gray-300 p-2 rounded">
// 					Load 100
// 				</button>
// 				{device.length >= 100 && (
// 					<button
// 						onClick={() => setPageLength(500)}
// 						className="bg-gray-300 p-2 rounded">
// 						Load 500
// 					</button>
// 				)}
// 				{/* Show previous button only for larger datasets */}
// 				{pageLength > 100 && (
// 					<button
// 						onClick={() => setPageLength(100)}
// 						className="bg-gray-300 p-2 rounded">
