...
const KeyboardForm: React.FC<KeyboardDetailsProps> = ({
  ...
  return (
    <div className="w-full">
      <div className="font-gilroyMedium text-base">Device Details</div>
      ...
      <div className="flex flex-col gap-1.5 mt-5">
        ...
        {isUploading ? (
          ...
          <div
            className="flex cursor-pointer flex-col items-center justify-center bg-[#E9F3FF] rounded-2xl border-dashed h-20 w-full border p-3 border-[#52ABFF]"
