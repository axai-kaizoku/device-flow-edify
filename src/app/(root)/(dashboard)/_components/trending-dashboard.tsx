...
function TrendingDevices({ data }:{data:Device[]}) {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold mb-6 text-gray-800">🔥 Trending Devices</h2>
                    ...
                    >
                        ...
                        <div className="p-4">
                            ...
                            <div className="text-sm text-gray-600 space-y-2">
                                <p>
                                    <span className="font-medium text-gray-700">Brand:</span> {device.brand}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-700">OS:</span> {device.os}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-700">Type:</span> {device.device_type}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-700">Serial No:</span> {device.serial_no}
                                </p>
                            </div>
                            ...
                            <div className="mt-4 flex items-center justify-between text-gray-700">
                                ...
                                <p className="text-lg font-bold text-red-500">₹{device.payable}</p>
                            </div>

                            {/* Call to Action */}
                            <button
                                onClick={() => handleSubmit(device._id)}
                                className="mt-6 w-full bg-black hover:bg-black/80 text-white text-sm font-medium py-2 rounded-lg transition-colors duration-300"
                            >
                                View Details
                            </button>
                        </div>
