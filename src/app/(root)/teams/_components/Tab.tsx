...
export function Tab({ active, onClick, label }: TabProps) {
  return (
    ...
    >
      <span
        className={`relative text-lg font-medium after:content-[''] after:absolute after:left-0 after:top-11 after:w-full after:h-[2px] after:transition-all after:duration-300 ${
          active
