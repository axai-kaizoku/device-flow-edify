...
import RaiseTicket from "../../tickets/[id]/_components/raise-ticket";
      ...
      {devices?.length > 0 ? (
        devices?.map((device: Device) => {
          ...
          return (
            ...
            >
              {/* Device Information */}
              <div className="flex flex-col  w-full gap-4 cursor-pointer">
                <div
                ...
                <RaiseTicket>
                  <div className=" min-w-full">
                    <div className="bg-black py-2 min-w-full text-lg font-gilroySemiBold rounded-full text-white">
                      Raise a Ticket
                    </div>
                  </div>
                </RaiseTicket>
