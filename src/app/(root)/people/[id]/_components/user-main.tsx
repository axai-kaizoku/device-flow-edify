				...
				<div className="flex flex-col gap-6">
					...
					<div className="w-96 flex items-center bg-white bg-opacity-80 backdrop-blur-[22.8px] border border-[rgba(195,195,195,0.31)] rounded-[50px] px-2 py-6">
						<div className='flex flex-col justify-start gap-5 items-start w-full px-6'>
							<div className='font-semibold text-gray-500 text-xl'>Personal Info.</div>
				...
				<div className="flex flex-col gap-6">
					...
					<div className="w-96 flex items-center bg-white bg-opacity-80 backdrop-blur-[22.8px] border border-[rgba(195,195,195,0.31)] rounded-[50px] px-2">
						<div className='flex flex-col gap-4 items-start w-full px-6 py-4'>
							<div className='font-semibold text-gray-500 text-xl'>Reporting Manager</div>
									...
									<div className='flex gap-2 mt-2 justify-start items-center'>
										...
										<div>
											{user?.teamId?.employees_count ?
												<div className='font-medium text-gray-500 text-sm'>{user?.teamId?.employees_count} Team Members</div> :
												<div className='font-medium text-gray-500 text-sm'>5 Team Members</div>
											}
										</div>
					...
					<div className="w-96 flex items-center bg-white bg-opacity-80 backdrop-blur-[22.8px] border border-[rgba(195,195,195,0.31)] rounded-[50px] px-2 py-6">
						<div className='flex flex-col justify-start gap-5 items-start w-full px-6'>
							<div className='font-semibold text-gray-500 text-xl'>Organisation Info.</div>
							...
							<div className='flex gap-4 items-center'>
								...
								<div className='flex flex-col'>
									...
									<div className='font-semibold'>{user.orgId?.legal_entity_name || "Hello"}</div>
								</div>
							</div>
							...
							<div className='flex gap-4 items-center'>
								...
								<div className='flex flex-col'>
									...
									<div className='font-semibold'>{user?.orgId?.office_address?.phone || "Hello"}</div>
								</div>
							</div>
							...
							<div className='flex gap-4 items-center'>
								...
								<div className='flex flex-col'>
									<div className='text-base text-gray-500 font-semibold'>Email</div>
									<div className='font-semibold'>{user.orgId?.email || "Hello"}</div>
								</div>
							</div>
							...
							<div className='flex gap-4 items-center'>
								...
								<div className='flex flex-col'>
									...
									<div className='font-semibold'>{user?.orgId?.office_address?.address || "Hello"}</div>
								</div>
							</div>
						</div>
					</div>
