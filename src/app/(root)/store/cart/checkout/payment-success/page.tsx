          ...
          <div className="flex flex-col items-center mt-8 gap-4">
            ...
            {showTextAndButtons ? (
              <div className="flex flex-col gap-3 animate-fade-in">
                <Link href='/store'>
                  <div className="text-base font-gilroySemiBold bg-black text-white px-9 py-4 rounded cursor-pointer" onMouseEnter={()=>{ router.push('/store');}} onClick={()=>{ router.push('/store'); }}>
                    Continue Shopping
                  </div>
                </Link>
