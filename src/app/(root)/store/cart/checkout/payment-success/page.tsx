      ...
      <div className="relative flex items-center justify-center w-40 h-40">
        ...
        {showCrackers && (
          ...
          className={`absolute flex items-center justify-center w-full h-full ${
            fadeOutCrackers ? "animate-fall-fade-out" : "animate-scale-up-center"
          }`} >
              <svg
                width="335"
                height="198"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <ellipse cx="52.3826" cy="68.7465" rx="6.71461" ry="6.53894" fill="#FF4B4B" />
                <ellipse cx="31.114" cy="174.63" rx="6.71461" ry="6.53894" fill="#FF4B4B" />
                <ellipse cx="301.436" cy="75.2855" rx="6.71461" ry="6.53894" fill="#FF4B4B" />
                <ellipse cx="269.093" cy="27.121" rx="6.71466" ry="6.53899" fill="#F04BFF" />
                <ellipse cx="246.992" cy="193.652" rx="3.91986" ry="3.81731" fill="#F04BFF" />
                <ellipse cx="273.013" cy="124.648" rx="3.91986" ry="3.81731" fill="#1EB600" />
                <ellipse cx="41.748" cy="124.648" rx="3.91986" ry="3.81731" fill="#FF00D4" />
                <ellipse cx="4.32318" cy="78.0073" rx="3.91986" ry="3.81731" fill="#FF00D4" />
                <ellipse cx="80.4394" cy="186.017" rx="3.91986" ry="3.81731" fill="#FFBB00" />
                <ellipse cx="327.656" cy="128.465" rx="7.26807" ry="7.07792" fill="#FFBB00" />
                <ellipse cx="108.75" cy="22.2083" rx="6.96924" ry="6.78691" fill="#00A6FF" />
                <ellipse cx="301.435" cy="168.091" rx="3.91986" ry="3.81731" fill="#00A6FF" />
                <ellipse cx="324.308" cy="28.9953" rx="3.91986" ry="3.81731" fill="#00A6FF" />
                <ellipse cx="45.6679" cy="18.3908" rx="3.91986" ry="3.81731" fill="#FFBB00" />
                <ellipse cx="209.745" cy="7.1635" rx="3.91986" ry="3.81731" fill="#00A6FF" />
              </svg>
          </div>
        )}
      </div>
        ...
        <div className="flex flex-col items-center mt-8 gap-4">
          ...
          {showTextAndButtons ? (
            <div className="flex flex-col gap-3 animate-fade-in">
              <Link href='/store'>
                <div className="text-base font-gilroySemiBold bg-black text-white px-9 py-4 rounded cursor-pointer" onMouseEnter={()=>{ router.prefetch('/store');}} onClick={()=>{ router.push('/store'); }}>
                  Continue Shopping
                </div>
              </Link>
