...
function IssueClosedHeader({ data }: { data: Issues[] }) {
  ...
  return (
    <div className="flex gap-3 px-6 py-5">
      <h1 className="text-xl font-gilroyMedium">Closed Issues</h1>
      <h1 className="px-2 justify-center items-center font-gilroyMedium flex text-sm rounded-full bg-info-foreground text-info">
        {closedCount} Issues
      </h1>
    </div>
  );
