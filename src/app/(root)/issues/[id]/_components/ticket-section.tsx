...
const TicketSection = ({ data }: { data: TicketData }) => {
  ...
  return (
    <div className="bg-white rounded-[10px] w-full border border-[rgba(0, 0, 0, 0.10)]  mt-3 flex h-[100vh] overflow-y-hidden">
      {/* Left Side */}
      <div className="w-[40%] h-full border border-r border-l-0 border-t-0 border-b-0 border-[rgba(0, 0, 0, 0.05)] overflow-y-auto">
        <div className="px-6">
          <div className="flex gap-2 items-center">
            <div className="mt-6 font-gilroySemiBold text-lg">{data?.category}</div>

            <div className="flex gap-2 mt-6">
              <p
                className={`px-2 h-fit py-1 justify-center items-center font-gilroyMedium flex text-xs rounded-full ${data?.closedAt
              ...
              <p
                className={`px-2 h-fit py-1 justify-center items-center font-gilroyMedium flex text-xs rounded-full ${data?.severity === "Medium"
          ...
          {data?.deviceDetails && <div className="border-[#E5E5E5] mt-6 border p-3 flex justify-between items-center rounded-md w-full cursor-pointer"  onClick={()=>{ router.push(`/assets/${data?.deviceDetails?._id}`);}}>
          ...
          <Dropdown title="Raised By" headerClassName="bg-[#F6F6F6] mt-6">
            <div className="space-y-3 px-2">
              <div className="flex items-center gap-12">
                ...
                <p className="text-sm font-gilroyMedium underline leading-[18.652px] pl-3 cursor-pointer" onClick={()=>{ router.push(`/people/${data?.openedByDetails?._id}`);}}>
