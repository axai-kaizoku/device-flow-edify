  ...
  return (
    <>
      <div className="w-full flex flex-col gap-6">
        <div className="font-gilroySemiBold text-2xl text-black">Bulk Import</div>
        <div className="w-full flex justify-between gap-4">
          <button
            className="flex-1 bg-black rounded-[49px] text-white font-gilroySemiBold text-lg py-2"
            onClick={handleFileUploadClick}
          >
            Upload CSV
          </button>
          <button
            className="flex-1 border border-[#5F5F5F] rounded-[49px] text-[#5F5F5F] font-gilroySemiBold text-lg py-2"
