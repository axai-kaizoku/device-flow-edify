...
export default function Header({session}:Props) {
	...
	return (
		<header className="fixed top-0 py-12 left-0 w-full h-16 bg-transparent backdrop-blur-3xl z-50 flex justify-between items-center px-12 ">
			{/* Logo Section */}
			...
			<div className="flex justify-center items-center ">
				<div className="flex items-center gap-x-4 lg:gap-x-2 2xl:gap-x-4 bg-transparent border border-gray-400 bg-opacity-90 rounded-[2.5rem] px-2.5 py-2">
					...
					<div 
						...
						<div className="text-gray-500 group-hover:text-white text-nowrap xl:text-base lg:text-sm 2xl:text-base">Add Device</div>
					</div>
					...
					<div className="flex gap-2 items-center rounded-full border border-gray-400 p-[0.43rem] hover:bg-black group">
						...
						{/* Text Section */}
						<div className="text-gray-500 group-hover:text-white text-nowrap xl:text-base lg:text-sm 2xl:text-base">Re/Assign</div>
					</div>


					<div className='flex gap-2 cursor-pointer items-center rounded-full border border-gray-400 p-[0.43rem] hover:bg-black group hover:text-white hover:border-white' onClick={()=>{ router.push('/people'); }}>
						...
						<div className="text-gray-500 group-hover:text-white text-nowrap xl:text-base lg:text-sm 2xl:text-base">Add Employee</div>
					</div>
				</div>
			</div>
