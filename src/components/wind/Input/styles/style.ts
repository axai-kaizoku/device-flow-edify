...
const InputContainerDisabled = css`
  ${(props: Props) =>
    props.disabled &&
    css`
...
const InputContainerFocused = css`
  ${(props: Props) =>
    props.error
      ? css`
...
export const InputContainer = styled.div`
  ...
  align-items: center;
  padding-left: ${({ isPaddingBefore }: Props) =>
    isPaddingBefore ? "12px" : "0px"};
  padding: ${({ isPaddingBefore, isPaddingAfter }: Props) =>
    isPaddingBefore && isPaddingAfter && "8px 12px !important"};
  padding-right: ${({ isPaddingAfter }: Props) =>
    isPaddingAfter ? "12px" : "0px"};
  border: ${(props: Props) =>
    props.error
...
export const PrefixWrapper = styled.div`
  ...
  flex: auto;
  gap: 12px;
  flex-wrap: ${({ addFlexWrap }: Props) => addFlexWrap && "wrap"};
  max-width: 100%;
  align-items: center;
`;
